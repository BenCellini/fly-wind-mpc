...
class MpcFlyWind:
    ...
    def run_mpc(self):
        ...
        # Add back initial controls
        self.u_mpc[0] = self.u_mpc[1]
    ...
    def replay(self, usim=None):
        ...
        # Replay
        if usim is None:  # use MPC controls
    ...
    def plot_trajectory(self, color=None, cmap=None, size=5, dpi=100, arrow_size=None, nskip=0):
